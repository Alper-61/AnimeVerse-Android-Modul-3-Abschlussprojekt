...
class FavoriteAnimeAdapter(private val list: List<EntityAnime>) :
    RecyclerView.Adapter<FavoriteAnimeAdapter.d>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): d {
        val l = LayoutInflater.from(parent.context)
            .inflate(R.layout.design_home_anime_characters, parent, false)
        return d(l)
    }
